        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b border-gray-100">
              ...
              <th className="text-left px-6 py-4 text-xs font-semibold text-gray-400 uppercase tracking-wider">Cliente ID</th>
          ...
          <tbody>
            ...
            {orders.map((o) => (
              <tr key={o.id} className="border-b border-gray-50 hover:bg-gray-50 transition-colors">
                ...
                <td className="px-6 py-4 text-gray-700 font-medium">Cliente #{o.customerId}</td>
          ...
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-sm">
            ...
            >
              ...
              <div>
                ...
                >
                  <option value="">
                    {form.customerId ? 'Seleccionar dirección...' : 'Primero elige un cliente'}
                  </option>
                  {addresses.map(a => (
